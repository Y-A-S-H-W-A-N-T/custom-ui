...
const Preference = (props) => {
  ...
  return (
    <>
      {loading && <Loading/>}
      {!loading && <div className={`p-4 sm:ml-64 font-one`} style={{background: `linear-gradient(to top,${userPreferences.theme1},${userPreferences.theme2},${userPreferences.theme3})`}} onClick={(e)=>Fire(e,'theme')}  onMouseOver={ () => {}} >
          <div className="">
            <div className={`p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700`} style={{backgroundColor: userPreferences.headbg}} onClick={(e)=>Fire(e,'header')} onMouseOver={ () => {}} >
          ...
          <div className="grid grid-cols-2 gap-4 mb-4 ">
              <div className="flex items-center flex-col justify-center rounded  h-28 ">
                <div  onClick={(e)=>Fire(e,'radio')} onMouseOver={ () => {}} >
              ...
              <div className="flex flex-col items-center justify-center rounded  h-28 ">
                ...
                <p className="lg:text-sm font-two text-black  flex flex-col "  onClick={(e)=>Fire(e,'dropdown')} onMouseOver={ () => {}} >
                  <DropDown
          ...
          <div  onClick={(e)=>Fire(e,'footer')} onMouseOver={ () => {}} >
